...
setup(name='bert-extractive-summarizer',
      ...
      install_requires=['numpy==1.16.3', 'torch==1.0.1', 'spacy==2.1.3', 'git+https://github.com/TheEdoardo93/bert-extractive-summarizer', 'Cython==0.29.10', 'tqdm==4.32.2', 'neuralcoref==4.0', 'argparse', 'scikit-learn'],
      license='MIT',
